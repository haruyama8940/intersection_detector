...
class deep_learning:
    ...
    # <to tensor img(x),intersection_label(t)>
        ...
        #sprint("x_cat:",self.x_cat.shape,"t_cat",self.t_cat.shape)
    ...
    def act_and_trains(self, train_dataset):
